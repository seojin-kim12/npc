...
function scene:create( event )
	...
	--오븐닫힘--
	local oven = {}
	oven[1] = display.newImage("이미지/도토리케이크/오븐_00(꺼짐).png")
	oven[2] = display.newImage("이미지/도토리케이크/오븐_01.png")
	oven[3] = display.newImage("이미지/도토리케이크/오븐_02.png")
	oven[4] = display.newImage("이미지/도토리케이크/오븐_03.png")
	oven[5] = display.newImage("이미지/도토리케이크/오븐_04.png")
	oven[6] = display.newImage("이미지/도토리케이크/오븐_05.png")
	oven[7] = display.newImage("이미지/도토리케이크/오븐_06.png")
	oven[8] = display.newImage("이미지/도토리케이크/오븐_07.png")
	oven[9] = display.newImage("이미지/도토리케이크/오븐_08.png")
	oven[10] = display.newImage("이미지/도토리케이크/오븐_09.png")
	oven[11] = display.newImage("이미지/도토리케이크/오븐_10.png")
	oven[12] = display.newImage("이미지/도토리케이크/오븐_11.png")
	oven[13] = display.newImage("이미지/도토리케이크/오븐_12.png")
	oven[14] = display.newImage("이미지/도토리케이크/오븐_13.png")
	oven[15] = display.newImage("이미지/도토리케이크/오븐_14.png")
	oven[16] = display.newImage("이미지/도토리케이크/오븐_15.png")
	...
	local function click(event)              
		...
		if j == 2 then
			...
			local function timeAttack(event)
				...
				if limit == 0 then 
					...
					composer.gotoScene("oven(acorn)3_3")              --view2로 넘겨줌--
				end
		...
		if j == 3 then
			...
			if time < 10 then
				...
				recipe.alpha=0
				showLimit.alpha=0
				composer.removeScene( "oven(acorn)2" )
				composer.setVariable("complete", true)
				local options={
					effect ="fade",
					time=300
				}
				composer.gotoScene("oven(acorn)3_1",options)
			end
			...
			if time == 10 then
				...
				composer.gotoScene("oven(acorn)3_2",options)
			end
			...
			if time > 10 then
				...
				composer.gotoScene("oven(acorn)3_3",options)
			end

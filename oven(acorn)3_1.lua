...
function scene:create( event )
	...
	--오븐닫힘--
    local oven={}
	oven[1] = display.newImageRect("이미지/도토리케이크/오븐_케이크_02.png", 200*7.2, 150*5.2)
	...
	for i=1,2 do
     ...
     --덜 익은 케이크--
     local cake = display.newImageRect("이미지/도토리케이크/케이크_2덜익음.png", 200*1.9, 150*1.7)
        ...
        if j==3 then
            ...
            local function click(event)              
                ...
                if j==1 then
                    recipe.alpha=0
                    display.remove(cake)
                    composer.removeScene( "oven(acorn)3_1" )

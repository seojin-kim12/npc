...
function scene:create( event )
	...
	--오븐닫힘--
    local oven={}
    oven[1] = display.newImageRect("이미지/도토리케이크/오븐_케이크_04.png", 200*7.2, 150*5.2)
    ...
    oven[1].alpha=1
     ...
     --다 탄 케이크--
     local cake = display.newImageRect("이미지/도토리케이크/케이크_4다탐.png",  200*1.9, 150*1.7)
        ...
        if j==3 then
            ...
            local function click(event)              
                ...
                if j==1 then
                    recipe.alpha=0
                    display.remove(cake)
                    composer.removeScene( "oven(acorn)3_3" )

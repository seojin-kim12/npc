...
function scene:create( event )
	...
	--오븐닫힘--
    local oven={}
	oven[1] = display.newImageRect("이미지/연어파이/오븐_연어파이_04.png", 200*7.2, 150*5.2)
    ...
    oven[1].alpha=1
     ...
     --완벽한 케이크--
     local cake = display.newImageRect("이미지/연어파이/잘익은파이.png", 200*2.4, 150*1.7)
	...
	local function click(event)              
        ...
        if j==3 then
            ...
            local function click(event)              
                ...
                if j==1 then
                    display.remove(cake)
                    composer.removeScene( "oven(pie)3_2" )

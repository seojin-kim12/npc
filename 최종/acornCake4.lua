...
function scene:create( event )
	...
	for i=1,2 do 
	 ...
	 --다 구워진 케이크를 놓는 곳--
	 local cake={}
	 cake[1] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크1단계.png", 200*4.2, 150*4.2)
	 cake[2] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크2단계.png", 200*4.4, 150*4.4)
	 cake[3] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크3단계.png", 200*4.4, 150*4.4)
	 cake[4] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크4단계.png", 200*4.4, 150*4.6)
	 cake[5] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크5단계.png", 200*4.4, 150*4.6)
	 cake[6] = display.newImageRect("이미지/음식/도토리케이크만들기/도토리케이크6단계.png", 200*4.4, 150*5.1)
								...
								elseif(event.phase == "ended" or event.phase == "cancelled") then 
									...
									local function click(event)
										...
										if k==2 then
											...
											recipe.alpha=0
											recipeApp.alpha=0
											composer.removeScene( "acornCake4" )
